...
- Strong preference for **TypeScript** (frontend) + **Python** (automation/AI)
- Personal productivity tools with AI integration (GPT-4o, Google APIs)
- Projects often solve Ameya's own real-world problems (knowledge base, contact management)
- Telegram bots as automation surfaces
